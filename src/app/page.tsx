    ...
    <div className="w-full min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <section id="about" className="min-h-screen py-12 md:py-20">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-12 tracking-tight" style={{color: '#ffffff'}}>About</h2>
        ...
        <section id="education" className="min-h-screen py-12 md:py-20">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-12 tracking-tight" style={{color: '#ffffff'}}>Education</h2>
          <div className="space-y-8">
            <div className="bg-white/5 rounded-2xl p-8 backdrop-blur-sm education-card">
              <div className="flex flex-col md:flex-row justify-between items-baseline gap-4 mb-6">
                <h3 className="text-3xl font-semibold tracking-tight" style={{color: '#ffffff'}}>
        ...
        <section id="experiences" className="min-h-screen py-12 md:py-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-10 tracking-tight" style={{color: '#ffffff'}}>Experience</h2>
...
immediate and long-term needs, ensuring development across industries</span>
        ...
        <section id="projects" className="min-h-screen py-12 md:py-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-10 tracking-tight" style={{color: '#ffffff'}}>Projects</h2>
...
system scalability and data retrieval</span>
        ...
        <section id="skills" className="min-h-screen py-12 md:py-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-10 tracking-tight" style={{color: '#ffffff'}}>Technical Skills</h2>
          <div className="grid grid-cols-1 gap-8">
        ...
        <section id="contact" className="min-h-screen py-12 md:py-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-10 tracking-tight" style={{color: '#ffffff'}}>Contact</h2>
